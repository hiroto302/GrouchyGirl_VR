...
public class MoveController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // {
            ...
            // if(playerTalkScript.GetConversationPartner() != null && OVRInput.GetDown(OVRInput.Button.One))
            // if(playerTalkScript.GetConversationPartner() != null && Input.GetKeyDown(KeyCode.S))
            // {
            //     SetState(State.Talk);
            // }
    ...
    //     if(state == State.Talk)
    //     {
    //         // playerTalkScript.StartTalking();  //会話開始！
    //         message.MessageStart();
    //     }
    // }
